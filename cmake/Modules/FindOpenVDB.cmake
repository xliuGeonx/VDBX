...
#MESSAGE("OPENVDB_LOCATION=${OPENVDB_LOCATION}")

IF( OPENVDB_LOCATION_FOUND )
  ...
  MESSAGE(${openvdb_major_version_str})
  ...
  MESSAGE(${_openvdb_major_version_number})
